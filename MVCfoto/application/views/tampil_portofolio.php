...
?>
			<div id="tes">
            <?php echo form_open('foto_controller/booknow'); ?> 
			 <?php echo form_hidden('id_gallery',$row->id_gallery,'id="id_gallery"'); ?>
 			
 			<?php echo "<h3>";echo"Judul:"; echo $row->judul; echo "</h1>"; echo "<br />"; ?> 
 			
			  <img src="<?php echo base_url()."/gallery/".$row->gambar; ?>" height="160px" width="160px" />
			  <?php echo "<br />"; echo"Tanggal Upload:";echo $row->tgl_post; echo "<br />";?>
 			<?php echo"Kategori:"; echo $row->kategori;  echo "<br />"; ?> 
 			 <?php echo form_submit('submit','BOOK','id="submit"'); echo form_close();  ?>
            </div>
<?php
