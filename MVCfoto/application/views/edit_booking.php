...
?>
			<tr>
			<?php echo form_open('foto_controller/updatebooking'); ?>
 			 <?php echo form_hidden('no_booking',$row->no_booking,'id="no_booking"'); ?>
			...
			<td><?php echo form_input('status',$row->status,'id="status"');?> </td>
