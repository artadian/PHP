...
<div id="templatemo_container">
	...
	<div id="templatemo_content_wrapper">
        ...
        <div class="column_w540	 fl vl_divider">
            ...
            <div class="header_01">Tambah Berita</div>
			<?php
				 echo form_open('foto_controller/tambahberita'); 
			?>
			<table>
				<tr>
					<td> Judul </td> <td> : </td> <td> <?php echo form_input('judul'); ?> </td>
				</tr>
				<tr>
					<td> Isi </td> <td> : </td>
					 <td> <?php 
					 ...
					 echo form_textarea($isi); ?> </td>
				</tr>
				<tr>
					<td>  </td> <td> </td> <td> <?php echo form_submit('submit','Tambah'); ?> </td>
				</tr>
			</table>
			<?php echo form_close();?>
